...
class LeafletMap extends PolymerElement {
    ...
    static get template() {
        return html`
<vaadin-horizontal-layout style="width: 100%; height: 7%; align-items: flex-end; spacing=XL ">
 <vaadin-button theme="icon" aria-label="Add new" style="align-items: flex-end;" id="vaadinButton">
  <iron-icon icon="lumo:arrow-left"></iron-icon>
 </vaadin-button>
 <h3 style="text-align: center"> Welcome to Hospital Management System Location Guide.</h3>
